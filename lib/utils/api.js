...
app.get("/v1/credits", (req, res) => {
    const getVisualPartnersWithMoreOf500Credits = new Controller().filterByCredits();
    res.status(200).send({"request": "credits", "data": getVisualPartnersWithMoreOf500Credits});
});
